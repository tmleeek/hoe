...
class BoiledEgg_Minify_Model_JSMinPlus
{
	private $parser;
	...
	public static function minify($js, $filename='')
	{
		...
		// this is a singleton
		if(!$instance)
			$instance = new BoiledEgg_Minify_Model_JSMinPlus();
...
class JSTokenizer
{
	...
	public function get($chunksize = 1000)
	{
		...
		if (!isset($this->tokens[$this->tokenIndex]))
			$this->tokens[$this->tokenIndex] = new BoiledEgg_Minify_Model_JSMinPlus_JSToken();
