...
$installer->getConnection()->insert($notifications_table, array(
    "type" => "cron_check",
    "message" => Mage::helper("klevu_search")->__('Cron has not run since Klevu Search was installed. This extension relies on cron for normal operation. Please check that you have Magento cron set up correctly. You can find instructions on how to set up Magento Cron <a target="_blank" href="http://www.magentocommerce.com/knowledge-base/entry/ce18-and-ee113-installing#install-cron">here</a>.')
));
