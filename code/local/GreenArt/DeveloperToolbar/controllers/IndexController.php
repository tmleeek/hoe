...
class GreenArt_DeveloperToolbar_IndexController extends Mage_Core_Controller_Front_Action
{
	function check()
	{
    ...
    {       
		...
		$this->_forward('noRoute');
	    	...
	    	if(!Mage::getStoreConfig('dev/css/merge_css_files') || !Mage::getStoreConfig('dev/developertoolbar/enabled'))
			$this->_forward('noRoute'); 		
			$this->_redirectReferer();
		}
    }    
