...
class Magestore_Inventoryplus_Adminhtml_WarehouseController extends Mage_Adminhtml_Controller_Action
{
    ...
    {                
        $this->loadLayout()
            ...
            ->_addBreadcrumb(
                Mage::helper('adminhtml')->__('Manage Warehouses'),
                Mage::helper('adminhtml')->__('Manage Warehouses')
            );
        return $this;
    }
    ...
    public function indexAction()
    {
        if( Mage::getModel('admin/session')->getData('warehouseaddmore_product_import'))
             Mage::getModel('admin/session')->setData('warehouseaddmore_product_import', null);         if( Mage::getModel('admin/session')->getData('null_warehouseaddmore_product_import'))
