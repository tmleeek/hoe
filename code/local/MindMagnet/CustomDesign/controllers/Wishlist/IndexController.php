...
class MindMagnet_CustomDesign_Wishlist_IndexController extends Mage_Wishlist_IndexController
{
    /**
    ...
    protected function _addItemToWishList()
    {
        ...
        try {
            ...
            $message = $this->__('%1$s a fost adăugat la lista dvs. de dorințe. Click <a href="%2$s">aici</a> pentru a continua cumpărăturile.',
