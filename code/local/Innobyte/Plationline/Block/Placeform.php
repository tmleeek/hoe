...
class Innobyte_Plationline_Block_Placeform extends Mage_Core_Block_Template
{
    ...
    /**
     * Plationline payment APi instance
     *
    ...
    /**
     * Get Form data by using plationline payment api
     *
     * @return array
     */
    ...
    public function poAuthTransaction()
    {
	return $this->_getApi()->poAuthTransaction($this->_getOrder());
    }
