...
class Magik_Innovasettings_Block_Adminhtml_System_Config_Form_Field_Footer extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _optionToHtml($element, $option, $selected)
    {
	    ...
	    $html .= '<img src="'.Mage::getDesign()->getSkinUrl('images/magik/innova/footer_'.$option['value'].'.jpg').'" alt="" /><br/>';
