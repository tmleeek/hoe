...
class Magik_Innovasettings_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="innovasettings_gfont_preview" style="font-size:20px; margin-top:5px;">Lorem Ipsum is simply dummy text</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
                this.fontElement = $("innovasettings_innovasettings_appearance_font");
                this.previewElement = $("innovasettings_gfont_preview");
                this.loadedFonts = "";
